...
#SBATCH -J bias_mse  #job name, this case:aw-area weighted aggregation
...
R CMD BATCH --quiet --no-restore --no-save bias_mse_lag1.R /n/home01/xwu1993/ts_ips2/output/test_${SLURM_ARRAY_TASK_ID}.Rout
