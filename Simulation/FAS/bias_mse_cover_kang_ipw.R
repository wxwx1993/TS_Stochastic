...
replicate = as.numeric(parameters[4])
  ...
  test <- ts_ipsi.ipw(dat = dat, x.kang, t_lag = t_lag, delta.seq = delta.seq, nsplits = 1, model = model)
...
subDir <- paste0("/n/home01/xwu1993/ts_ips2/ipw/n", n, "_T", T, "_lag", t_lag, "_", model, "_kang")
