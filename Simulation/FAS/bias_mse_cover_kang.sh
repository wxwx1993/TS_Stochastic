...
#SBATCH -J dr_bias_mse_cover_kang  #job name, this case:aw-area weighted aggregation
...
R CMD BATCH --quiet --no-restore --no-save bias_mse_cover_kang.R /n/home01/xwu1993/ts_ips2/output/test_dr_${SLURM_ARRAY_TASK_ID}.Rout
